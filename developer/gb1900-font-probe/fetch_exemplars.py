...
ADMIN = [
 ...
 ("boroughs_munic","Boroughs (Municipal)","B",(1495,2650,150,92),"caps",True,"both",""),
 ...
 ("div_counties","Divisions of Counties (Ridings)","R",(3808,1455,215,200),"caps",True,"pre1879",""),
 ("poor_law_unions","Poor Law Unions","R",(3822,1745,128,142),"caps",True,"both","old Yorks/Lancs = Registrars Districts"),
 ("urban_sanitary","Urban Sanitary Districts","R",(3822,1892,128,132),"caps",True,"both",""),
 ("cities_mp","Cities returning Members","C",(3825,2062,150,132),"caps",True,"pre1879","bold"),
 ("cities_nomp","Cities not returning Members","C",(3825,2198,150,132),"caps",True,"pre1879",""),
 ("wards","Wards","W",(3825,2365,150,128),"caps",True,"both",""),
 ("market_towns","Market Towns","B",(3820,2520,155,118),"italic",True,"pre1879",""),
 ("other_towns","Other Towns","B",(3820,2665,155,95),"italic",True,"pre1879",""),
 ("parl_div_counties","Parliamentary Division of Counties","P",(3812,2788,150,160),"caps",True,"recent","'more recent maps' (>=1879)"),
...
TEXT = [
 ...
 ("chapelries","Chapelries. Other Churches","cs_settlement.jpg",(0.15,0.30),(0.10,1),"italic",False,"pre1879",""),
 ("other_villages","Other Villages","cs_settlement.jpg",(0.30,0.44),(0,1),"italic",False,"both",""),
 ("parks_word","Parks","cs_settlement.jpg",(0.44,0.585),(0.12,0.44),"caps",True,"both","bold caps"),
 ...
 ("harbours_word","Harbours","cs_water.jpg",(0.08,0.34),(0.575,0.995),"caps",True,"both","UPRIGHT caps (NOT italic)"),
 ("navigable_rivers_word","Navigable Rivers","cs_water.jpg",(0.34,0.58),(0.045,0.78),"italic",True,"both","italic CAPS"),
 ("small_rivers","Small Rivers & Brooks","cs_water.jpg",(0.58,0.80),(0.16,0.98),"italic",False,"both","italic title-case"),
 ("antiq_roman","Antiquities: Roman","cs_antiq.jpg",(0.03,0.25),(0.27,0.70),"caps",True,"both","SAME face as road names"),
 ("antiq_saxon","Antiquities: Pre-historic or Saxon","cs_antiq.jpg",(0.25,0.45),(0.30,0.80),"blackletter",False,"both",""),
...
EXTRA = [
 ...
 ("ranges_hills","Ranges of Hills",(1726,2658,388,56),388,"caps",True,"both","* SIZE-VARIABLE (header)"),
 ("extra_parochial","Extra Parochial",(1745,2842,680,92),560,"caps",True,"pre1879","excl. †"),
 ("turnpike_trusts","Turnpike Trusts",(2435,2842,850,92),580,"italic",True,"pre1879","bold italic caps; excl. †"),
 ("railways_passenger","Railways (Passenger)",(1720,2946,780,92),540,"upright",False,"both","RAILWAYS upright caps + (Passenger) italic"),
 ("railways_mineral","Railways (Mineral)",(2465,2946,860,92),580,"italic",False,"both","RAILWAYS italic caps + (Mineral) italic"),
...
PEND = [
 ("county_bridges",(1690,2085,1240,150),720,I1897,10),      # 'County Bridges. Trust Bridges & Others. Isolated Houses'
