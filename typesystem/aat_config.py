...
Standalone version — no Django dependencies. Extracted from the legacy
placetypes Django app with identical configuration values.
...
DATA_DIR = TYPES_DIR / "data"
AAT_CACHE_DIR = DATA_DIR / "aat_cache"
...
# ---------------------------------------------------------------------------
# AAT SPARQL endpoint (for programmatic queries)
# ---------------------------------------------------------------------------
AAT_SPARQL_ENDPOINT = "http://vocab.getty.edu/sparql"

# AAT JSON-LD API template
AAT_JSON_API = "https://vocab.getty.edu/aat/{aat_id}.json"
