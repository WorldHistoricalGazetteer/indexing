...
bibtex pdf/phonetic-embeddings
...
# Copy Files
cp phonetic-embeddings.tex $SUBMISSION_DIR/
cp pdf/phonetic-embeddings.bbl $SUBMISSION_DIR/
...
rm -f $SUBMISSION_DIR/phonetic-embeddings.pdf
