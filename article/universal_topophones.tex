...
This paper presents such a system, which we call \emph{Symphony}. Our key contributions are:
...
\toprule
\textbf{Feature} & \textbf{Rama (2016)}  & \textbf{Mueller \& Thyagarajan} & \textbf{Sagi et al.\ (MEHDIE)} & \textbf{Symphony} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Comparison of approaches to string similarity. Sagi et al.\ use rule-based transliteration exploiting Semitic phonetic affinity. Symphony uses Epitran/PanPhon articulatory features, enabling cross-script matching across 20 writing systems without language-pair-specific rules.}
