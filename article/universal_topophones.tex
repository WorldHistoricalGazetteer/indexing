...
\item Section 1 (Introduction): "67 million" placeholder
\item Section 4.4 (Dataset Statistics): Entire section marked \placeholder{REVISE} - needs new statistics from gn/wd/tgn extraction
...
The resulting vocabulary contains approximately 3,500--4,000 tokens across all scripts, each tagged with its source script for embedding lookup. The exact size depends on the character distribution in the corpus at extraction time.
