...
\begin{enumerate}
\item Run the coverage queries to assess actual script/language distribution
\item Execute extraction with source es.sh -train-extract 3
\item Review extraction_stats.json for actual numbers
...
\begin{enumerate}
\item Add architecture diagram: Consider adding a TikZ figure showing Teacher-Student data flow
\item Add training curves: Plot loss curves for each phase when available
