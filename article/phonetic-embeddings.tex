...
% Set Libertinus Serif as main font
\setmainfont[
...
I do not directly compare against GeoBERTTM~\citep{qiu2024geobert} as their model requires Chinese-specific features (Pinyin, radicals, strokes) unavailable for multilingual test sets. However, their published results are reported for context, and the complementary strengths of the two approaches are discussed.
