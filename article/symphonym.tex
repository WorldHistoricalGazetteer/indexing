...
\paragraph{MEHDIE Benchmark.} I additionally evaluate on the MEHDIE Hebrew-Arabic toponym benchmark~\citep{mehdie2025}, which provides 1,200 annotated pairs from medieval geographical texts. This benchmark tests cross-script matching between two related Semitic scripts---a challenging case where my phonetic approach should excel compared to romanisation-based methods that lose script-specific phonetic information.
