...
\begin{enumerate}
    \item Re-run \texttt{rebuild\_toponyms\_index.py} with updated Epitran extensions, Phonikud, and CharsiuG2P (using targeted language updates to minimize model reloads) to generate PanPhon embeddings for previously-excluded toponyms
